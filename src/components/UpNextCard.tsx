...
const UpNextCard = () => {
  ...
  return (
    <div className="bg-card rounded-xl p-5 shadow-soft">
      ...
      <button
        onClick={handleStart}
        className="mt-4 w-full flex items-center justify-center bg-primary text-primary-foreground font-semibold text-sm transition-all hover:opacity-90 active:scale-[0.98] py-3 gap-[8px] rounded-3xl">

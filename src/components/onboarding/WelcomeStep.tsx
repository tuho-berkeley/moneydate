...
<div className="w-full max-w-sm text-center space-y-8 animate-fade-in">
    <div className="space-y-4">
      ...
      <p className="text-muted-foreground text-sm leading-relaxed text-pretty">Money conversations don't have to feel awkward. Explore your shared values and plan the future together.

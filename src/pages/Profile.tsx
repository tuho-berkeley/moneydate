      ...
      <div className="max-w-lg mx-auto">
        ...
        <div className="px-6 space-y-5">
          {goals.length > 0 && (
            <div>
              ...
              <div className="space-y-2">
                {goals.map((goal, i) => (
                  <div key={i} className="bg-card rounded-2lp-4 shadow-card flex items-center gap-3">
          ...
          <div>
            ...
            <div className="bg-card rounded-2x shadow-card divide-y divide-border overflow-hidden">
